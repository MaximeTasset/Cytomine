...
#Maxime Tasset
class ImageSequence(Collection):

    def __init__(self, params = None):
        super(ImageSequence, self).__init__(ImageInstance, params)

    def to_url(self):
        if hasattr(self, "imagegroup"):
            return "imagegroup/" + str(self.imagegroup) + "/imagesequence.json"
        else:
