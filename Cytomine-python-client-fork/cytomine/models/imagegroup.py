...
class ImageGroup(Model):
    ...
    def image_groupHDF5(self):
        uri = "imagegroup/{}/imagegroupHDF5.json".format(self.id)
#        json = Cytomine.get_instance().get(uri)
        return ImageGroupHDF5(**Cytomine.get_instance().get(uri))
